...
def parse_input() -> list[list[list[int]]]:
  ...
  Each game is a list of rounds
  Each round is a list of colors [red, green, blue]
  """
    ...
    for round in game.split('; '):
      ...
      for color in round.split(', '):
        ...
        if color_type == 'red':
          ...
          colors[1] = color_count
        elif color_type == 'blue':
          colors[2] = color_count
...
def is_valid_game(game: list[list[int]]) -> bool:
  for round in game:
...
def main1():
  inputs = parse_input()
  valid_games = [i + 1 for (i, g) in enumerate(inputs) if is_valid_game(g)]
...
def main2():
  ...
  for game in inputs:
    ...
    for round in game:
      if round[0] > min_possible[0]:
        min_possible[0] = round[0]
      if round[1] > min_possible[1]:
        min_possible[1] = round[1]
      if round[2] > min_possible[2]:
        min_possible[2] = round[2]

    sum += min_possible[0] * min_possible[1] * min_possible[2]
