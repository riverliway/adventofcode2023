  ...
  for inp in inputs:
    ...
    for i in range(len(inp)):
      if inp[i].isdigit():
        value = 10 * int(inp[i])
        break
      if inp[i:].startswith('one'):
        value = 10
        break
      if inp[i:].startswith('two'):
        value = 20
        break
      if inp[i:].startswith('three'):
        value = 30
        break
      if inp[i:].startswith('four'):
        value = 40
        break
      if inp[i:].startswith('five'):
        value = 50
        break
      if inp[i:].startswith('six'):
        value = 60
        break
      if inp[i:].startswith('seven'):
        value = 70
        break
      if inp[i:].startswith('eight'):
        value = 80
        break
      if inp[i:].startswith('nine'):
        value = 90
        break
    ...
    for i in reversed(range(len(inp))):
      if inp[i].isdigit():
        value += int(inp[i])
        break
      if inp[:i+1].endswith('one'):
        value += 1
        break
      if inp[:i+1].endswith('two'):
        value += 2
        break
      if inp[:i+1].endswith('three'):
        value += 3
        break
      if inp[:i+1].endswith('four'):
        value += 4
        break
      if inp[:i+1].endswith('five'):
        value += 5
        break
      if inp[:i+1].endswith('six'):
        value += 6
        break
      if inp[:i+1].endswith('seven'):
        value += 7
        break
      if inp[:i+1].endswith('eight'):
        value += 8
        break
      if inp[:i+1].endswith('nine'):
        value += 9
        break
